...
public class BookServiceImpl implements BookService {
    private final static String BOOKS_FILE_PATH =
            "C:\\Users\\NAVI\\IdeaProjects\\BookShopSystem\\src\\main\\resources\\files\\books.txt";
    ...
    public Set<String> getAllAuthorsWithBookBefore() {
        ...
        return books.stream().map(b->String.format("%s %s",b.getAuthor().getFirstName(),b.getAuthor().getLastName()))
